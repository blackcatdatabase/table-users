...
final class UserRepository implements RepoContract {
     ...
     * [ 'email_hash' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'email_hash_key_version', 'password_hash', 'password_algo', 'password_key_version', 'is_active', 'is_locked', 'failed_logins', 'must_change_password', 'last_login_at', 'last_login_ip_hash', 'last_login_ip_key_version', 'actor_role', 'updated_at', 'deleted_at' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $keys = [ 'email_hash' ];
        $upd  = [ 'email_hash_key_version', 'password_hash', 'password_algo', 'password_key_version', 'is_active', 'is_locked', 'failed_logins', 'must_change_password', 'last_login_at', 'last_login_ip_hash', 'last_login_ip_key_version', 'actor_role', 'updated_at', 'deleted_at' ];
