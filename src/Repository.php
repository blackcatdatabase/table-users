...
use BlackCat\Database\Packages\Users\Repository\UserRepository as GeneratedRepository;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof UserRepositoryInterface) {
            ...
            throw new \InvalidArgumentException('Expected UserRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\Users\Dto\UserDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\Users\Dto\UserDto|null { return $this->repo->getById($id, $asDto); }
