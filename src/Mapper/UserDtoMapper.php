...
final class UserDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'failed_logins' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'email_hash', 'email_hash_key_version', 'password_algo', 'password_key_version', 'last_login_at', 'last_login_ip_hash', 'last_login_ip_key_version', 'deleted_at' ];
