...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'email_hash', 'email_hash_key_version', 'password_hash', 'password_algo', 'password_key_version', 'is_active', 'is_locked', 'failed_logins', 'must_change_password', 'last_login_at', 'last_login_ip_hash', 'last_login_ip_key_version', 'created_at', 'updated_at', 'version', 'deleted_at', 'actor_role' ];
    }
    ...
    {
        $x = [ 'id', 'email_hash_key_version', 'password_hash', 'password_algo', 'password_key_version', 'is_active', 'is_locked', 'failed_logins', 'must_change_password', 'last_login_at', 'last_login_ip_key_version', 'created_at', 'updated_at', 'version', 'deleted_at', 'actor_role' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\Users\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\Users\Definitions::softDeleteColumn();
